...
TMP_PATH = os.path.realpath(os.path.join(os.path.dirname(os.path.realpath(__file__)),'..','temp'))
...
for filter_feat in list(elylyr)+[None,]:
    ...
    zf = zipfile.ZipFile(os.path.join(sys.path[0],'elyt','linjaukset_%s.zip' % (filter_area_name,)),'w')
    print 'Creating zip'
